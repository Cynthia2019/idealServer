...
if __name__ == '__main__':
    ...
    c1 = np.array([604591262.41, 102330968.98, 1157840534.65, 0.00, 0.00, 156833419.95])
    c2 = np.array([604591262.41, 102330968.98, 1157840534.65, 0.00, 0.00, 156833419.95])
    c3 = np.array([604591262.41, 102330968.98, 1157840534.65, 0.00, 0.00, 156833419.95])
    c4 = np.array([604591262.41, 102330968.98, 1157840534.65, 0.00, 0.00, 156833419.95])
    cs = [c1, c2, c3, c4]

    data = pd.read_csv('../data/smallsample.csv', usecols=['C11', 'C12', 'C22', 'C16', 'C26', 'C66'])
    print(data.shape)
